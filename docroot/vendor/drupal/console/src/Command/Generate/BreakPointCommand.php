...
class BreakPointCommand extends Command
{
    ...
    {
        $this
            ->setName('generate:max_example')
            ->setDescription($this->trans('commands.generate.max_example.description'))
            ->setHelp($this->trans('commands.generate.max_example.help'))
            ->addOption(
                'theme',
                null,
                InputOption::VALUE_REQUIRED,
                $this->trans('commands.generate.max_example.options.theme')
            )
            ->addOption(
                'breakpoints',
                null,
                InputOption::VALUE_OPTIONAL | InputOption::VALUE_IS_ARRAY,
                $this->trans('commands.generate.max_example.options.breakpoints')
            )->setAliases(['gb']);
    }
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if (!$theme) {
            ...
            $theme = $this->getIo()->choiceNoList(
                $this->trans('commands.generate.max_example.questions.theme'),
                array_keys($themes)
            );
